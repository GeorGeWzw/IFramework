...
using IFramework.EntityFrameworkCore.InMemory.Internal;
...
{
    public class RedisTransactionManager: IDbContextTransactionManager, ITransactionEnlistmentManager
    {
        private static readonly RedisTransaction StubTransaction = new RedisTransaction();
        ...
        /// </summary>
        public RedisTransactionManager([NotNull] IDiagnosticsLogger<DbLoggerCategory.Database.Transaction> logger)
        {
            _logger = logger;
        }
