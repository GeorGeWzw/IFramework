...
namespace IFramework.EntityFrameworkCore.Redis.Storage.Internal
{
    public class RedisDatabaseCreator: IDatabaseCreator
    {
        ...
        public RedisDatabaseCreator([NotNull] IDatabase database)
        {
            _database = database;
        }
        ...
        /// </summary>
        protected virtual IRedisDatabase Database => (IRedisDatabase)_database;
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public virtual bool EnsureCreated() => throw new NotImplementedException();
