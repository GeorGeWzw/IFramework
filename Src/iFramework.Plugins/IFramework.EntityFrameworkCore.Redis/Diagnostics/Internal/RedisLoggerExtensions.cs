...
using IFramework.EntityFrameworkCore.Redis.Properties.Internal;
...
namespace IFramework.EntityFrameworkCore.InMemory.Internal
{
    /// <summary>
    ...
    public static class RedisLoggerExtensions
    {
        ...
        {
            var definition = RedisResources.LogTransactionsNotSupported(diagnostics);
        ...
        public static void ChangesSaved(
            ...
            int rowsAffected)
        {
            var definition = RedisResources.LogSavedChanges(diagnostics);
